...
def captura_bug():
  ...
  global path
  global name
  screenshot = pyautogui.screenshot(region=(770,210, 394, 794))
  i =i+1
...
def captura_ok():
  ...
  global name
  nombre=""
  screenshot = pyautogui.screenshot(region=(770,210, 394, 794))#pyautogui.screenshot(region=(770,210, 394, 794))
  i =i+1
  nombre=name +"_" + str(i)
